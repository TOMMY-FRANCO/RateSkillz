/*
  # Fix Reward Functions to Handle UUID Coin Pool ID

  Updates all reward functions to properly query coin_pool table without assuming integer ID.
  Uses ORDER BY and LIMIT to get the single coin pool record.
*/
