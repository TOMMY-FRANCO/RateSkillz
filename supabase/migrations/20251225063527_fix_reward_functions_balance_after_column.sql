/*
  # Fix Reward Functions to Use Correct Transaction Column Name

  Updates all reward functions to use `balance_after` instead of `running_balance` for coin_transactions.
*/
