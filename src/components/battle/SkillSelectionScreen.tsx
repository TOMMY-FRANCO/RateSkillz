      ...
      <GlassCard className="p-6">
        ...
        <p className="text-white/70 mb-6">
          {isAttacker
            ...
            : 'Choose a card to defend against the attack'}
        </p>
        ...
        {!isAttacker && selectedCard && (
          <div>
            <h4 className="text-xl font-bold text-white mb-4">Card Selected</h4>
            <p className="text-white/70">
              Your card is ready to defend. Click Confirm to proceed.
            </p>
          </div>
        )}
